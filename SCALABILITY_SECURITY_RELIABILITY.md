...
Detailed operational standards, SLO engineering, distributed systems patterns, ML architecture, serverless patterns, and security architecture are formally defined in the CTO Operating System (docs/architecture/*).
